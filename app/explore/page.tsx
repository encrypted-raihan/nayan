...
export default function ExplorePage() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("nayan:satellites-cleared", onSatellitesCleared); window.addEventListener("nayan:earthquakes-error", onError); window.addEventListener("nayan:natural-events-error", onError);
    return () => {
      ...
      window.removeEventListener("nayan:satellites-cleared", onSatellitesCleared); window.removeEventListener("nayan:earthquakes-error", onError); window.removeEventListener("nayan:natural-events-error", onError);
    };
  }, []);
